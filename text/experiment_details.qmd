...
t_blank2 <- 200
t_ast <- 500
font_ast <- "16-point case Helvetica"
t_trial2 <- 25
t_exp2 <- "25 minutes"
```
...
the number of preambles that may serve as a plural head was `r round((32+19)/(32+19+34+11),2)`% of the total items.
...
that stayed in the screen for `r t_ast` ms
and presented in black `r font_ast` font on a white background.

Following blank screen and fixation point,
the full sentence was presented in the center of the screen
and stayed on the screen for `r t_trial2` seconds.
...
A total of `r Npart` participants will be recruited through Prolific.
They will be paid `r paid` US dollars.
