---
title: "A priori tendency to associate Bare Plurals with Genericity"
shorttitle: "Bare Plurals and Genericity"
date: last-modified

author:
  - name        : Utku Turk, University of Maryland, College Park
  - name        : Ellen Lau, University of Maryland, College Park
...
Previous ERP research (LauLiao2017) have found a sustained increase in neural activity in structurally connected NPs compared to their unconnected counterparts for natural language materials (e.g. sunlit ponds and green umbrellas vs. sunlit ponds ### green umbrellas). However, this sustained anterior negativity response was not observed for jabberwocky materials (e.g. suncy kads and whisy cawregrols). Moreover, a recent study showed that the same manipulation will not result in the same effect when the coordinands are definite plural NPs (LauYang2023).

Results from jabberwocky and definite materials suggest that previous findings were not due to structural

- One possibility it related to semantic contribution of BPs and genericity.
- If people associate BPs with genericity and the previous effects are due to semantic integration, we should see some reflection of it in an offline task.
