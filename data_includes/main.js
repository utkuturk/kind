...
newTrial(
  ...
  newTextInput("ProlificID")
    .before(newText("ID", "Your Prolific ID:").settings.css("font-size", "1.3em"))
    .settings.css("font-size", "1.3em")
    ...
    .log(),
  newTextInput("Age")
    .before(newText("AGE", "Your age:").settings.css("font-size", "1.3em"))
    .settings.css("font-size", "1.3em")
    .settings.css("width", "50%")
    .settings.css("margin", "auto")
    .print()
  ...
  newTextInput("Language")
    .before(
      newText("LANG", "Your native language:").settings.css("font-size", "1.3em")
    )
    .settings.css("font-size", "1.3em")
    .settings.css("width", "50%")
    .settings.css("margin", "auto")
...
newTrial(
  ...
  ).settings.css("font-size", "1.3em").print(),
  newButton("Next")
    .center()
    .settings.css("font-size", "1.3em")
    .settings.css("margin", "40px")
...
newTrial(
  "instruction2",
  newText(
    "In the experiment you will see sentence fragments as the following"
  ).settings.css("font-size", "1.3em").print(),
  newText("example_premable", "Mehmet Efendi")
    .center()
    .cssContainer({ "margin-right": "1.3em" })
    .settings.css("font-size", "1.3em")
    .print(),
  newTextInput("answer")
...
PennController(
  ...
  ).settings.css("font-size", "1.3em").center().print(),
